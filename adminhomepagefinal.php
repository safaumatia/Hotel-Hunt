...
<body>
        ...
        <div class="row">
          <div class="col">
            <div class="header_inner d-flex flex-row align-items-center justify-content-start">
              <nav class="main_nav">
                <ul class="d-flex flex-row align-items-center justify-content-start" style="margin-left: 600px;">
                  ...
                  <li ><a href="Home Page.php"><div class="nav_item d-flex flex-column align-items-center justify-content-center"><span>LogOut</span></div></a></li>
                </ul>
              </nav>
  ...
  <div class="menu">
	...
	<div class="mainpage">
		<div class="admin">
		<p class="see"><a href="display.php">Cutomer Details</a></p>
	</div>
	<br>
	<br>
	<br>
	<div class="admin">
		<p class="see"><a href="aftermainpagehotelbutton.php">Hotel Details</a></p>
	</div>
	<br>
	<br>
	<br>
	<div class="admin">
		<p class="see"><a href="signupadmin.php">Add admin</a></p>
	</div>
	</div>
