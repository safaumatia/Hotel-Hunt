...
$qy = "select * from book where name='$name'";
...
<div style="height: 970px; width: 600px; border: 4px solid #5a2360; margin-left: 350px; border-radius: 10px;">
  <h3 style="background: #5a2360; height: 70px; width: 595px; color:white; text-align: center; padding-top: 8px;">BOOKING SUCCESSFULL</h3>
  <p style="color: black; font-weight: bold; font-size: 20px; margin-left: 15px; margin-top: 15px;">USER ID: <?php echo $res['id']; ?></p>
  <p style="color: black; font-weight: bold; font-size: 20px; margin-left: 15px; margin-top: 15px;">NAME: <?php echo $_SESSION['name']; ?></p>
  ...
  <p style="color: black; font-weight: bold; font-size: 20px; margin-left: 15px; margin-top: 15px;">HOTEL NAME: <?php echo $res['hotelname']; ?></p>
  <p style="color: black; font-weight: bold; font-size: 20px; margin-left: 15px; margin-top: 15px;">NO OF KIDS: <?php echo $res['no_kids']; ?></p>
  <p style="color: black; font-weight: bold; font-size: 20px; margin-left: 15px; margin-top: 15px;">NO OF ADULTS: <?php echo $res['no_adults']; ?></p>
  <p style="color: black; font-weight: bold; font-size: 20px; margin-left: 15px; margin-top: 15px;">NO OF ROOMS: <?php echo $res['no_rooms']; ?></p>
  <p style="color: black; font-weight: bold; font-size: 20px; margin-left: 15px; margin-top: 15px;">CHECK IN DATE: <?php echo $res['checkin_date']; ?></p>
  <p style="color: black; font-weight: bold; font-size: 20px; margin-left: 15px; margin-top: 15px;">CHECK OUT DATE: <?php echo $res['checkout_date']; ?></p>
  <p style="color: black; font-weight: bold; font-size: 20px; margin-left: 15px; margin-top: 15px;">PREFERRED SERVICES: <?php echo $res['services']; ?></p>
  <button style="height: 50px; width: 400px; font-size: 20px; margin-top: 30px; margin-left: 85px; background: #5a2360; color: white; border-radius: 20px; border: none; " class="newbutton"><a href="Home Page.php" style="color:white">Done</a></button>
</div>
