...
<header class="header">
    ...
    <div class="login-box" style="height: 1000px; margin-top: 300px;">
        <h1 style="text-align: center; padding-bottom: 20px;" class="loginhere">Add Admin</h1>
            <form action="adminsignup.php" method="post">        
            <p>First Name</p>
            <input type="text" class="form-control" name="firstname" placeholder="Enter firstname" required="true">
            <p>Last Name</p>
            <input type="text" class="form-control" name="lastname" placeholder="Enter lastname" required="true">
            <p>Contact</p>  
            <input type="number" class="form-control" id="phone" name="contactno" maxlength="10" placeholder="Enter number" 
            ...
            <input type="password" class="form-control" name="confirmpassword" placeholder="Enter Password"required="true">
            <br><br>
           <div>
            <button class="buttonnew" type="submit"><b>Add Admin</b></button>  
           </div>
