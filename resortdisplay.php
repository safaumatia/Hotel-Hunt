...
?>
			...
			<tr class="text-center" style="color:black;">
				...
				<td><button class="btn btn-danger"><a href="deleteresort.php?id=<?php echo $res['id']; ?>" class="text-white">DELETE</a></button></td>
				<td><button class="btn btn-success"><a href="updateresort.php?id=<?php echo $res['id']; ?>" class="text-white">UPDATE</a></button></td>
				<td><button class="btn btn-primary"><a href="viewresort.php?id=<?php echo $res['id']; ?>" class="text-white">VIEW</a></button></td>
			</tr>
