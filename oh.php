...
position: relative;
background: #fff;
box-shadow: 0px 30px 45px rgba(0,0,0,0.7);
border-radius: 4px;
...
.LIST:hover
{
box-shadow: 75px solid transparent;
transform:scale(1.1);
}
...
include 'conn.php';
    ...
    $q = "select id,hotel_name,address  from crudhotel";
...
<p><b><?php echo $res['hotel_name']; ?></b> <br>
   <span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span> <br>
<?php echo $res['address']; ?></p>
<a href="aromaview.php?id=<?php echo $res['id']; ?>"><button type="button" class="btn btn-outline-dark" title="Click here to get more details about  given hotel "> VIEW MORE DETAILS </button></a>
</div>
</a>
</div>
